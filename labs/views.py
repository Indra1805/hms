    ...
    def get(self, request):
        ...
        for test in serialized.data:
            ...
            simplified_data.append({
                ...
                "action": detail_url,
                # Send full image URL so frontend can render it directly
                "result": request.build_absolute_uri(upload_file) if upload_file else None
            })
