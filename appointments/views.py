...
class AppointmentCreateAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            appointment = models.Appointment(**req_params)
            appointment.save()
...
class AppointmentRetrieveAPIView(APIView):
    def get(self, request, appointment_id):
        try:
            ...
            appointment_data = app_serializers.AppointmentSerializer(appointment, context={"request": request}).data

            # Optional stats block (can be removed if unnecessary)
            ...
            active_inpatients = models.Appointment.objects.filter(appointment_type='inpatient').count()
            active_outpatients = models.Appointment.objects.filter(appointment_type='outpatient').count()
            active_casualty = models.Appointment.objects.filter(appointment_type='casuality').count()
            ...
            return Response({
                ...
                "stats": {
                    ...
                    "active_cases": {
                        "inpatients": active_inpatients,
                        "outpatients": active_outpatients,
                        "casualty": active_casualty
                    },
...
class AppointmentListAPIView(APIView):
    def get(self, request):
        try:
            ...
            appointments_data = app_serializers.AppointmentSerializer(queryset, many=True, context={"request": request}).data
